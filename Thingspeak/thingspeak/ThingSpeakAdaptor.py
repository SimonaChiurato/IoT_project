...
//qui cambio commento
    ...
    def notify(self, topic, msg):
        ...
        //sostituire e con message
        if d["message"][0]["type"]=="temperature":
            self.field1_data= d["message"][0]["value"]
        elif d["message"][0]["type"]=="humidity":
            self.field2_data= d["message"][0]["value"]
        elif d["message"][0]["type"]=="CO2":
            self.field3_data= d["message"][0]["value"]
